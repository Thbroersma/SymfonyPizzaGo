 ...
 */
final class Version20220421121236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD amount INT NOT NULL, CHANGE status status VARCHAR(50) NOT NULL');
    }
